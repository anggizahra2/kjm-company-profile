...
### Catatan
- Fitur **form kontak (email)** dan **upload foto** memakai integrasi Emergent (`EMERGENT_EMAIL_KEY` & `EMERGENT_LLM_KEY`) — hanya berfungsi saat di-deploy di platform Emergent. Tanpa key, website tetap jalan normal; hanya email & upload yang nonaktif.
